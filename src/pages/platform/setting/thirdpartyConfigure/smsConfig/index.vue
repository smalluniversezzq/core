    ...
    <div v-if="configWrapShow">
      ...
      >
        ...
        >
          ...
          <a-form-model-item label="AccessKeyID" prop="sms_aliyun_accesskeyid">
            <a-input placeholder="请输入AccessKeyID" v-model="formData.sms_aliyun_accesskeyid" />
          </a-form-model-item>
          ...
          <a-form-model-item label="阿里签名" prop="sms_aliyun_signname">
            <a-input placeholder="请输入阿里签名" v-model="formData.sms_aliyun_signname" />
          </a-form-model-item>
...
export default {
  ...
  data(){
    return {
      ...
      typeList: [
        {
          ...
          rules: {
            sms_aliyun_accesskeyid: [ { required: true, message: "AccessKeyID", trigger: "blur" }, ],
            sms_aliyun_accesskeysecret: [ { required: true, message: "AccessKey Secret", trigger: "blur" }, ],
            sms_aliyun_signname: [ { required: true, message: "阿里签名", trigger: "blur" }, ],
          },
          bgImg: bg6,
          link: [
            {
      ...
      saveResult: [],
      keyOfValue: {
        sms_aliyun_accesskeyid: 'AccessKeyID',
        sms_aliyun_accesskeysecret: 'AccessKey Secret',
        sms_aliyun_signname: '阿里签名',
      },
