        ...
        <div class='helps-reletive'>
          ...
          <div class='icon-help'>
            <a-tooltip placement="right">
              ...
              <byf-icon type="iconhelp" style='widht:20px' :size='30'></byf-icon><span class='ml-sm'>说明</span>
            </a-tooltip>
          </div>
...
<script>
  ...
  import {AdminUserUserLevelSetUpRebateInfo} from "@/services/platform/vips.js";
  ...
  export default{
    ...
    mounted(){
      if(this.levelList){
        ...
        // 获取等级
        // let agent = this.levelList.info.agent
        this.data = []
    ...
    methods:{
      ...
      AdminUserUserLevelSetUpRebateInfoFn(){
        this.formData.id = this.id
        console.log(this.formData,'AdminUserUserLevelSetUpRebateInfoFn')
        // console.log(AdminUserUserLevelSetUpRebateInfoFn)
        AdminUserUserLevelSetUpRebateInfo(this.formData).then(res=>{
          if(res.code === 200){
      ...
      submit(){
        ...
        this.AdminUserUserLevelSetUpRebateInfoFn()
      },
      goBack(){
      ...
      tabColumnsFn(){
        ...
        console.log(agentColumns,'agentColumns')
        this.columns = agentColumns
        this.columnWidth = this.templateSlot.length*120 + 200 
        console.log(this.columnWidth,'columnWidth')
      },
    }
  }
</script>
