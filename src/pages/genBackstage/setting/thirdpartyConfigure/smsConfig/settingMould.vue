...
export default {
  data(){
    const data = [
        {
          type: '登录模板',
          key: 'sys_sms_aliyun_template_login',
          code: '',
        },
        {
          type: '注册模板',
          editable: false,
          key: 'sys_sms_aliyun_template_register',
          code: '',
          saveLoading: false,
        },
        {
          type: '通用验证码模板',
          key: 'sys_sms_aliyun_template_yzm',
          code: '',
        }
    ]
    ...
    return {
      ...
      formData: {
        sys_sms_aliyun_template_login: '',
        sys_sms_aliyun_template_register: '',
        sys_sms_aliyun_template_yzm: ''
      },
    }
  },
  created(){
