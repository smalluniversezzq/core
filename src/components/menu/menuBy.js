...
export default {
  ...
  created() {
    this.updateMenu()
    if (this.options[0] && !this.options[0].fullPath) {
  ...
  methods: {
    ...
    renderItem: function (h, menu) {
      ...
      if (!meta || !meta.invisible) {
        ...
        if (children != undefined && !this.hideMenuLevels.includes(meta.menuLevel + 1)) {
    ...
    getSelectedKey(route) {
      if ((route.meta.invisible || this.hideMenuLevels.includes(route.meta.menuLevel)) && route.parent) {
