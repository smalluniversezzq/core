export default {
  ...
  mutations: {
    setUserPlatformCount(state, counts){
      state.user.platform_limit = counts.platform_limit;
      state.user.platform_current = counts.platform_current;
      state.user.platform_remain = counts.platform_remain;
